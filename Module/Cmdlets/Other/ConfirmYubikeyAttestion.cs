...
namespace powershellYK.Cmdlets.Other
{
    ...
    public class ConfirmYubikeyAttestionCommand : PSCmdlet
    {
        ...
        // temp storage for the attestion objectdata
        ...
        protected override void ProcessRecord()
        {
            ...
            if (chain.Build(_AttestionCertificate) == false)
            {
                Attestion returnObject = new Attestion(false);
            ...
            else
            {
                ...
                {
                    switch (_AttestionCertificate.PublicKey.GetRSAPublicKey()!.KeySize)
                    {
                        case 1024:
                ...
                else if (_AttestionCertificate.PublicKey.Oid.FriendlyName == "ECC")
                {
                    switch (_AttestionCertificate.PublicKey.GetECDsaPublicKey()!.KeySize)
                    {
                        case 256:
