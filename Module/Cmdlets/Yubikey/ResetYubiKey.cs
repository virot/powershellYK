...
{
    [Cmdlet(VerbsCommon.Reset, "YubiKey", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    public class ResetYubiKeyCmdlet : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                WriteInformation("YubiKey factory reset successful.", new string[] { "YubiKey", "Reset" });
            }
            catch (Exception ex)
            {
                ThrowTerminatingError(
