...
namespace powershellYK.Cmdlets.Fido
{
    ...
    {
        [Parameter(Mandatory = false, ValueFromPipeline = false, HelpMessage = "Interactive mode for removing and reinserting YubiKey")]
        public Boolean Interactive { get; set; } = true;
